            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">검색결과 페이지 - MovieSearchResult.jsp</h1>
                    </div>
                    <!-- Content Row -->
                    <!-- Content Row -->
                    <div class="row">
						...
						<c:forEach items="${searchMvList }" var="movie" >
                    ...
                    <div class="row">
						<div class="col-12">
							<div class="card mb-2">
                                <div class="card-header py-3 text-center bg-primary">
                                    <h6 class="m-0 font-weight-bold h5 text-white">예매 가능한 영화 목록</h6>
                                </div>
                            </div>							
						</div>
